...
- (void) drawView {
    ...
    credentialsTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 270, self.view.bounds.size.width, 400) style:UITableViewStyleGrouped];
    UIView *clearBackBuffer = [[UIView alloc] initWithFrame:credentialsTableView.bounds];
    [clearBackBuffer setBackgroundColor:[UIColor clearColor]];
    [credentialsTableView setDelegate:self];
    [credentialsTableView setDataSource:self];
    [credentialsTableView setBackgroundView:clearBackBuffer];
    [self.view addSubview:credentialsTableView];
...
- (void) drawLoginButton {
    UIButton *loginButton = [[UIButton alloc] initWithFrame:CGRectMake(130, 875, 500, 66)];
    ...
    loginButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:21.0f];
...
- (void) drawRememberLoginControl {
    ...
    remMeLabel = [CustomUI makeLabel:@"Remember Me?" x_value:50 y_value:397 width:250 height:30 back_color:[UIColor clearColor] font:[UIFont fontWithName:@"HelveticaNeue-Medium" size:19.5f] text_color:[UIColor whiteColor] linebreakmode:NSLineBreakByWordWrapping shadow_color:[UIColor lightGrayColor] shadow_off:CGSizeMake(0, 1)];
    
    [remMeCntl setOnTintColor:[UIColor colorWithRed:106.0 / 255 green:199.0 / 255 blue:80.0 / 255 alpha:1.0]]; // 124	221	97
    [remMeCntl setTintColor:[UIColor colorWithRed:124.0 / 255 green:221.0 / 255 blue:97.0 / 255 alpha:1.0]]; // 72	178	97
    [remMeCntl setThumbTintColor:[UIColor colorWithRed:65.0 / 255 green:152.0 / 255 blue:41.0 / 255 alpha:1.0]]; // 65	152	41
    
    remMeCntl = [[UISwitch alloc] initWithFrame:CGRectMake(self.view.bounds.size.width - 125, 401, 58, 19)];
...
- (void) drawCreateLoginButton {
    createLoginButton = [[UIButton alloc] initWithFrame:CGRectMake(185, 560, 395, 56)];
    ...
    createLoginButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:16.5f];
...
- (void) displayFailedLogin {
    if (!errorCurrentlyInView) {
        ...
        /* Stats Label ~ [CustomUI makeLabel] */
        error = [CustomUI makeLabel:@"Ouch! Credentials Failed." x_value:0 y_value:247 width:self.view.bounds.size.width height:34 back_color:[UIColor clearColor] font:[UIFont fontWithName:@"HelveticaNeue-Medium" size:21.5f] text_color:[UIColor whiteColor] linebreakmode:NSLineBreakByWordWrapping shadow_color:[UIColor lightGrayColor] shadow_off:CGSizeMake(0, 1)];
...
- (void) createTabBar {
    ...
    [[UITabBar appearance] setBackgroundImage:[UIImage imageNamed:@"tabbar_bg_center_ipad"]];
...
- (UITableViewCell *) tableView:(UITableView *)table cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        loginId = [[UITextField alloc] initWithFrame:CGRectMake(5, 0, 555, 21)];
        loginId.placeholder = @"";
        loginId.textAlignment = NSTextAlignmentLeft;
    ...
    if (indexPath.row == 1) {
        password = [[UITextField alloc] initWithFrame:CGRectMake(5, 0, 555, 21)];
