...
+ (void)PrintCheckedBlockWithPortName:(NSString *)portName portSettings:(NSString *)portSettings widthInch:(int)printableWidth {
    NSData *commands = nil;
    ...
    @try
    {
        ...
        [starPort beginCheckedBlock:&printerStatus :2];
        ...
        [starPort endCheckedBlock:&printerStatus :2];
        
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Success"
                                                        message:@"Printing has been completed successfully."
                                                       delegate:nil
                                              cancelButtonTitle:@"OK"
                                              otherButtonTitles:nil];
